...
info = dotenv_values("app/.env")  # поменять на app/.env
SQLALCHEMY_DATABASE_URL = "postgresql+psycopg2://{0}:{1}@{2}:{4}/{3}".format(info['LOGIN'], info['PASSWORD'],
                                                                             info['HOST'], info['NAME'], info['PORT'])
